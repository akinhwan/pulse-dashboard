# [Healthcare Hackathon Cape Girardeau 2019](https://healthcare-hackathon-2019.devpost.com)
...
- Clone the repo: `git clone https://github.com/akinhwan/pulse-dashboard.git`.
    - `npm install`
    - `npm run serve`
- [Download from Github](https://github.com/akinhwan/pulse-dashboard.git/archive/master.zip).
...
1. Make sure that you are using the latest version of the Pulse Dashboard.
...
If you have questions or need help integrating the product please [contact us](https://www.akinhwan.site) instead of opening an issue.
